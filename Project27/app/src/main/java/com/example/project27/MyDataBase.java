...
public class MyDataBase extends SQLiteOpenHelper {
    ...
    public static final class WorkDB {
        ...
        public static String[] getNote(Cursor cursor){
            ...
            String[] note = new String[] {id, text, time};
            return note;
        }
        public static long insertNote(SQLiteDatabase db, String headtext, String text, String time){
        ...
        public static long editNote(SQLiteDatabase db,String id, String headtext, String text){
            ContentValues values = new ContentValues();
            values.put(COLUMN_HEADTEXT, headtext);
            values.put(COLUMN_TEXT, text);
