...
public class AdapterValute extends BaseAdapter {
    ...
    double coef;
    String flag = "";
    public AdapterValute(Context _context, List<Valute> _list, double _coef){
        context = _context;
        list = _list;
        coef = _coef;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = layoutInflater.inflate(R.layout.levalute, parent, false);
        }
        ...
        int id1 = context.getResources().getIdentifier("com.example.fotytwowork:drawable/" + flag, null, null);
